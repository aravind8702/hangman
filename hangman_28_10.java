...
class hangman_28_10
{
    ...
    void main_menu()throws FileNotFoundException
    {
        ...
        switch(menu)
        {
            ...
            System.out.println("\fThis project is done by Aravind Krishnan Anand and Advik Giridhar.\nHangman is a game in which one player tries to guess the letters of a word \nwhich is generated by the computer which is basically the developers i.e. us.\nWe record the failed attempts by the player by drawing a gallow and a man hanging on it,line by line (mistake by mistake).\nHence the game is called HANGMAN.");
    ...
    {
        if (choice == 1)
            arr = new String[]{"idli", "aloo paratha", "cereal", "pancake", "dosa", "omelette","baked beans"};
        if (choice == 2)
        ...
        if (choice == 3)
            arr = new String[]{"badminton", "tennis", "volleyball", "hockey", "archery", "wrestling", "golf", "surfing","kayaking", "canoeing", "rafting", "diving", "rowing", "synchronised swimming", "boxing", "gymnastics", "cycling", "discus throw", "archery", "fencing", "judo", "karate", "kickboxing", "long jump", "high jump", "pole vault", "sprint", "walking", "weightlifting", "cricket", "dodgeball", "football", "golf", "handball", "ice hockey", "lacrosse", "polo", "rugby", "squash", "skydiving", "paragliding", "parachuting", "snowboarding", "formula racing", "chess"};
        if (choice == 4)
        ...
        if (choice == 6)
            arr = new String[]{"pomegranate", "avocado", "passion fruit", "cranberry", "apricots", "cantaloupe", "nectarine"};
        if (choice == 7)
            arr = new String[]{"racoon", "bison", "kangaroo", "panther", "rhinoceros", "hedgehog", "armadillo", "hyena"};
